...
public class Server {
    ...
    private static int shortened = 0; // shortened game off by default
	...
	if(args.length > 0) {
	    shortened = Integer.parseInt(args[0]);
	}
	...
	System.out.println(name + " is done playing.");
    }
    ...
    private static void setDeck(int shortened) {
